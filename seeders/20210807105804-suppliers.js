        ...
        return queryInterface.bulkInsert('suppliers', [
            {
                ...
                current_number_of_pallets: 50,
                max_number_of_pallets: 200,
                createdAt: new Date(),
                updatedAt: new Date()
            },
            {
            ...
            },
            {
                ...
                geo_lon: 4.914082,
                allowed_weight: 1000,
                current_cargo_weight: 700,
                current_number_of_pallets: 600,
                max_number_of_pallets: 1000,
                createdAt: new Date(),
                updatedAt: new Date()
            },
